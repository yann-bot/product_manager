  ...
  return (
    <div className="wrap">
      <form className="form" method="post" action={action}>
        ...
        <div className="field">
          <label htmlFor="unitCost">Prix de revient unitaire</label>
          <input
            id="unitCost"
            name="unitCost"
            type="number"
            min="0"
            step="0.01"
            defaultValue={numStr(v.unitCost)}
          />
          <span className="sub" style={{ marginTop: 4 }}>
            Coût d'achat unitaire du lot (entrée). Si vide, le coût de revient du produit est utilisé.
          </span>
        </div>

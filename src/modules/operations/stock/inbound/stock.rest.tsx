...
const movementSchema = z.object({
  ...
  // Prix de revient unitaire (entrée 'in'). Optionnel : si vide, le service
  // retombe sur le coût de revient du produit.
  unitCost: z.preprocess(
    emptyToUndefined,
    z.coerce
      .number()
      .nonnegative("Le prix de revient ne peut pas être négatif.")
      .optional(),
  ),
